...
| --------------------------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/`                               | Players   | Splash landing with combined player/team search, all-season top-decile featured players, offseason champion team, and community drafts.                                                                                                                                                                                                                       |
| `/players`                        | Players   | Player-specific lookup and featured players backed by the NHL-ID-first v2 index.                                                                                                                                                                                                                                                                               |
| `/players/legacy`                 | —         | Legacy name/season/position player dashboard retained for old shared links.                                                                                                                                                                                                                                                                                    |
| `/players/v2`                     | —         | Alias for the NHL-ID-first v2 player search.                                                                                                                                                                                                                                                                                                                   |
| `/players/v2/:playerId`           | —         | Responsive v2 skater or goalie profile with role-specific tendencies and quality, box scores, similar players, season selection, and shareable export; skaters also retain NHL EDGE.                                                                                                                                                                           |
| `/players/profile-preview`        | —         | Static skater profile concept used to review the redesigned presentation.                                                                                                                                                                                                                                                                                      |
| `/players/goalie-profile-preview` | —         | Static goalie profile concept used to review the redesigned presentation.                                                                                                                                                                                                                                                                                      |
...
| `/teams/roster`                   | —         | Most-used non-overlapping MoneyPuck 5v5 lines and defense pairs with observed offense/defense/physicality/overall ratings. "Modify" mode uses a real-combination neighbor model to re-project edited units live.                                                                                                                                               |
| `/expansion-draft`                | Draft     | V2 NHL Expansion Draft Emulator — pick a season and claim one locally calculated unprotected NHL-ID player per franchise.                                                                                                                                                                                                                                     |
| `/expansion-draft/result`         | —         | V2 team analysis with simulated percentile stats, similar teams, age/opponent-adjusted record, roster and shareable card; saved-roster refreshes use the unrestricted team-analysis endpoint.                                                                                                                                                                  |
...
The active featured, roster, lineup analyzer, expansion-draft, and synthetic
team-analysis flows use the backend `/v2` API contracts through
`src/lib/api/apiService.js`. Legacy endpoint methods remain only for the
explicit `/players/legacy` compatibility page.
