...
|------|-----------|-------------|
| `/` | Players | Search for a player by name, season, and position. View percentile stats, WAR, similar players, and counting stats. |
...
The header links to Players, Teams, and About. `/loader` is available by URL only.
