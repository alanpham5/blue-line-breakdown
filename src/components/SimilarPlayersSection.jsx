...
export const SimilarPlayersSection = ({ players, onPlayerClick, filterYear, onFilterYearChange }) => {
  ...
  return (
    <div className="bg-gray-800/50 backdrop-blur rounded-2xl p-4 sm:p-6 border border-gray-700">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <select
            ...
            className="flex-1 sm:flex-initial min-w-0 bg-gray-700/50 border border-gray-600 rounded-lg px-3 sm:px-4 py-2 text-white text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          >
