...
export const BookmarkButton = ({
  ...
  return (
    <button
      ...
      className={`inline-flex ${dims} items-center justify-center rounded-full border transition-all duration-200 disabled:opacity-60 ${active ? "border-amber-300/40 bg-amber-300/15 text-amber-300 light:border-amber-500/40 light:bg-amber-500/15 light:text-amber-600" : "border-white/15 bg-white/5 text-gray-300 hover:bg-white/10 hover:text-white light:border-slate-300 light:bg-white/60 light:text-slate-500 light:hover:text-slate-900"} ${className}`}
    >
