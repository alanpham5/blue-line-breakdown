      ...
      <div ref={containerRef} className="relative">
        ...
        {open && (
          <div
            ...
            role="listbox"
            className="absolute inset-x-0 z-[70] top-[calc(100%+0.5rem)] max-h-[min(28rem,65vh)] overflow-y-auto rounded-[24px] border border-white/10 bg-[#0b0d12] p-2 shadow-2xl light:border-slate-200 light:bg-white"
          >
            {error ? (
