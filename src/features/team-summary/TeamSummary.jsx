        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative z-10">
            {hasSearched && teamSummaryData ? (
              <div className="liquid-glass-strong relative z-50 mb-8 grid grid-cols-1 gap-3 overflow-visible rounded-[32px] p-4 sm:grid-cols-[2fr_1fr] sm:items-center sm:gap-4 sm:p-5">
                <GeneralSearch
                  bare
                  compact
                  scope="teams"
              ...
              <div
                className={`liquid-glass-strong mb-8 rounded-[32px] p-5 sm:p-7 ${enablePageLoadAnimations ? "liquid-glass-animate" : ""}`}
                style={{
                  overflow: "visible",
                }}
              >
